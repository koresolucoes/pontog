...
export const FlameIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 5c-5 2.5-8 7-8 11.5 0 3.5 3.5 6.5 8 6.5s8-3 8-6.5c0-4.5-3-9-8-11.5z" />
        <path d="M12 16c-2.5 0-4-1.5-4-3.5 0-2 1.5-3.5 4-3.5s4 1.5 4 3.5c0 2-1.5 3.5-4 3.5z" />
    </svg>
);
...
export const ScaleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 22a8 8 0 0 0-8-8c0-4.42 3.58-8 8-8s8 3.58 8 8a8 8 0 0 0-8 8z" />
        <path d="M12 2v2" />
        <path d="M12 12l4-4" />
    </svg>
);
